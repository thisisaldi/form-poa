    ...
    <div className="max-w-6xl space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm" style={{ color: "var(--color-text-muted)" }}>
          ...
          Ini target value keseluruhan, bukan target produk fokus — lihat halaman{" "}
          <a href="/admin/target-produk" style={{ color: "var(--color-blue)" }}>Target Produk Fokus</a> untuk itu.
