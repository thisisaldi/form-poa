...
// MissingNexusUsersCard ("Cek User Belum Sync dari Nexus") removed 2026-09-22
// (Aldi: "kita sudah tidak pakai nexus") — was a read-only diagnostic for
// when org sync wasn't automated yet; org sync now runs live via
// orgAndOutletScheduler.ts, and Nexus isn't in use anymore.
