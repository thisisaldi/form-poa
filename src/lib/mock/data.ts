...
export const MOCK_USERS: User[] = [
  { nip: "NSM001", name: "Budi Santoso",   role: Role.NSM, jabatan: null, email: "budi@example.com",  nipAtasan: null,     namaAtasan: null,            kodeWilayah: null,      namaWilayah: null,          isActive: true, isDummy: false, syncedAt: NOW, createdAt: EARLIER, updatedAt: NOW, project: null },
  { nip: "SM001",  name: "Rina Wulandari", role: Role.SM,  jabatan: null, email: "rina@example.com",  nipAtasan: "NSM001", namaAtasan: "Budi Santoso",  kodeWilayah: "REG-01",  namaWilayah: "REG JAWA",    isActive: true, isDummy: false, syncedAt: NOW, createdAt: EARLIER, updatedAt: NOW, project: null },
  { nip: "ASM001", name: "Agus Pratama",   role: Role.ASM, jabatan: null, email: "agus@example.com",  nipAtasan: "SM001",  namaAtasan: "Rina Wulandari",kodeWilayah: "AREA-01", namaWilayah: "AREA JAKARTA",isActive: true, isDummy: false, syncedAt: NOW, createdAt: EARLIER, updatedAt: NOW, project: null },
  { nip: "MR001",  name: "Siti Rahayu",    role: Role.MR,  jabatan: null, email: "siti@example.com",  nipAtasan: "ASM001", namaAtasan: "Agus Pratama",  kodeWilayah: "GT-01",   namaWilayah: "GT JAKARTA 1",isActive: true, isDummy: false, syncedAt: NOW, createdAt: EARLIER, updatedAt: NOW, project: null },
  { nip: "MR002",  name: "Dodi Prasetyo",  role: Role.MR,  jabatan: null, email: "dodi@example.com",  nipAtasan: "ASM001", namaAtasan: "Agus Pratama",  kodeWilayah: "GT-02",   namaWilayah: "GT JAKARTA 2",isActive: true, isDummy: false, syncedAt: NOW, createdAt: EARLIER, updatedAt: NOW, project: null },
];
