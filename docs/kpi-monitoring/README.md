...
🟢 **Kredensial staging DAN production sudah aktif & terverifikasi 2026-08-24** — `VendorCode: TradeMarketing`, kredensial berbeda per environment (host terpisah), diserahkan ke pengguna untuk dimasukkan ke Vault (production via Bryan). PTID per NIP diambil dari `User.sippAbsPtId`, diisi dari file master HR (`scripts/importSippPtidFromHrFile.ts`, dijalankan 2026-09-23) — bukan tebakan awalan huruf lagi. Detail di `01-business-rules.md` §2d.
