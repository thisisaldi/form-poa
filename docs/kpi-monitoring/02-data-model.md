...
| Customer Expansion (kandidat) | `PsspKontrak` aktif per outlet yang di-cover MR | `getActivePsspByOutlets()` (`src/app/actions/customer.ts`), sudah dipakai Summary page untuk `activeCustKeys`. |
