...
4. ~~**Customer Expansion** — proxy PSSP aktif cukup?~~ **Terkonfirmasi (2026-07-30, user)** — betul, yang terhitung cuma customer dengan PSSP AKTIF (`prdAkhir >= periode berjalan`, via `getActivePsspByOutlets`), bukan yang PSSP-nya sudah habis/expired. Ini bukan lagi asumsi kerja.
